...
def resnext(baseWidth=4, cardinality=32, head7x7=True, layers=(3, 4, 23, 3), num_classes=1000):
    """
    Construct ResNeXt.
    (2, 2, 2, 2) for resnext26
    ...
    """
    model = ResNeXt(baseWidth=baseWidth, cardinality=cardinality, head7x7=head7x7, 
