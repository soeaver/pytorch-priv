...
""" 
Creates a SE-ShuffleNet Model as defined in:
...
__all__ = ['se_shufflenet', 'se_shufflenet_w2g3', 'se_shufflenet_w15g3', 'se_shufflenet_w1g3', 'se_shufflenet_w05g8']
...
class SEShuffleAddBlock(nn.Module):
    def __init__(self, inplanes, outplanes, groups=3):
        super(SEShuffleAddBlock, self).__init__()
...
class SEShuffleConcatBlock(nn.Module):
    def __init__(self, inplanes, outplanes, groups=3, first_group=True):
        super(SEShuffleConcatBlock, self).__init__()
...
class SE_ShuffleNet(nn.Module):
    def __init__(self, groups=3, widen_factor=1.0, num_classes=1000):
        ...
        """
        super(SE_ShuffleNet, self).__init__()
        ...
        self.groups = groups
        self.addblock = SEShuffleAddBlock
        self.concatblock = SEShuffleConcatBlock
...
def se_shufflenet(groups=3, widen_factor=1.0, num_classes=1000):
    """
    Construct SE_ShuffleNet.
    """
    model = SE_ShuffleNet(groups=groups, widen_factor=widen_factor, num_classes=num_classes)
    return model


def se_shufflenet_w2g3():
    model = SE_ShuffleNet(groups=3, widen_factor=2.0, num_classes=1000)
    return model


def se_shufflenet_w15g3():
    model = SE_ShuffleNet(groups=3, widen_factor=1.5, num_classes=1000)
    return model


def se_shufflenet_w1g3():
    model = SE_ShuffleNet(groups=3, widen_factor=1.0, num_classes=1000)
    return model


def se_shufflenet_w05g8():
    model = SE_ShuffleNet(groups=8, widen_factor=0.5, num_classes=1000)
    return model
